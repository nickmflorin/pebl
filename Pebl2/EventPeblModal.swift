...
class EventPeblModal: UIViewController {
    
    /////////////////////////
    // MARK: Properties
    @IBOutlet weak var messageField: UITextView!
    @IBOutlet weak var eventField: UITextField!
    @IBOutlet weak var date_timeField: UITextField!
    
    @IBOutlet weak var pickup_peblButton: UIButton!
    ...
    /////////////////////////
    //MARK: Actions
    @IBAction func pickupPeblButtonClicked(_ sender: AnyObject) {
